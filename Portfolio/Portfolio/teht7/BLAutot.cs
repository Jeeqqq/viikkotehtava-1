...
namespace Portfolio.teht7
{
    public class BLAutot
    {
        ...
        public static void VieAutot(List<Auto> autoLista)
        {
            ...
            Serialisointi.SerialisoiXml(HttpContext.Current.Server.MapPath("~/data/WanhatAutot.xml"), autot);
        }
        ...
        public static bool authenticateUser(string userName, string passWord)
        {
            ...
            Serialisointi.deSerialisoiKayttajat(HttpContext.Current.Server.MapPath("~/data/users.xml"), ref kayttajat);
