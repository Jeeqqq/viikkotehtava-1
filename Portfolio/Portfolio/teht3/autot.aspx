<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="autot.aspx.cs" Inherits="Portfolio.teht3.autot" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:TextBox ID="TextBox1" runat="server" ToolTip="Hae merkin tai mallin mukaan" ></asp:TextBox><asp:Button ID="Button1" runat="server" Text="Hae" onClick="Button1_Click"/>
    <asp:ListBox ID="ListBox1" runat="server" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged" AutoPostBack="True" style="float:left;" ViewStateMode="Enabled" EnableViewState="true"  ></asp:ListBox>
        ...
        <LayoutTemplate>
          <table cellpadding="2" width="640px" border="1" runat="server" style="margin:10px 10px 10px 10px;" id="tblCars">
            <tr id="Tr1" runat="server">
              ...
              <th id="Th5" runat="server">Myynti Hinta <asp:LinkButton ID="sortByPrice" runat="server" CommandName="Sort" CommandArgument="MyyntiHinta" >Sort by price</asp:LinkButton></th>
