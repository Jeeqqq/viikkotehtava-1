<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="LevykauppaX.aspx.cs" Inherits="Portfolio.teht4.WebForm1" %>
        ...
        <LayoutTemplate>
         ...
         <ItemTemplate>
          <tr id="Tr2" runat="server">
            <td>
               <asp:Image runat="Server" ImageUrl='<%#Eval("Kuva") %>' />
            </td>
            <td>
              <div  runat="Server">
